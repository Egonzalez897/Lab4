...
public class Colosseum {
    ...
    /**
     * The max added defense and attack a pokemon can have
     */
    ...
    public static Pokemon buildPokemon() {
        ...
        while (tempPokemon.hitPoints < 1 || tempPokemon.hitPoints > MAX_HIT_POINTS) {
            System.out.println("Please enter the hitpoints of the pokemon, must be between 1 and 50");
            tempPokemon.hitPoints = myScan.nextInt();
        }
        System.out.println("Split 50 points between attack and defense");
        while (tempPokemon.attackLevel > MAX_STATS - 1 || tempPokemon.attackLevel < 1) {
            System.out.println("How many hit points will it have? (1-49):");
            tempPokemon.attackLevel = myScan.nextInt();
        }
        while (tempPokemon.defenseLevel > MAX_STATS - tempPokemon.attackLevel || tempPokemon.defenseLevel < 1) {
            System.out.println("Enter your defense level (1-" + (MAX_STATS - tempPokemon.attackLevel) + "):");
